      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="flex justify-start md:justify-center">
            <nav aria-label="Quick links" className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              ...
              <a href="/wealthcraft" className="text-sm text-slate-300 hover:text-white transition">Wealthcraft</a>
              <a href="/alphalabs" className="text-sm text-slate-300 hover:text-white transition">Alphalabs</a>
              <a href="/ventures" className="text-sm text-slate-300 hover:text-white transition">Ventures</a>
              <a href="/insights" className="text-sm text-slate-300 hover:text-white transition">Insights</a>
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
            <div className="flex items-center space-x-3">
              <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-slate-300 hover:text-white transition">
              ...
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-slate-300 hover:text-white transition">
              ...
              <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-slate-300 hover:text-white transition">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-slate-800 mt-8 pt-6 text-xs text-slate-500">
          <div className="flex flex-col md:flex-row md:justify-between gap-4">
            <div>
              <a href="/legal" className="hover:text-white transition mr-4">Legal</a>
