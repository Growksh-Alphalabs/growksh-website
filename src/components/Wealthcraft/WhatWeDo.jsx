        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="px-2 sm:px-0">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 leading-tight animate-fadeUp">
              Life changes.{' '}
              <span className="bg-clip-text text-transparent bg-linear-to-r from-emerald-600 to-emerald-400">
            ...
            >
              Whether you're a working professional managing multiple goals, a
              woman balancing priorities, or an NRI planning across borders — we
              help you bring structure, direction, and peace to your financial
              life.
            </p>
            ...
            >
              <a
                href="#consult"
                className="inline-flex items-center px-6 py-3 rounded-full font-semibold text-white shadow-md focus:outline-none focus:ring-2 focus:ring-emerald-300 hover:shadow-lg transition-shadow duration-300"
          ...
          <div className="relative px-2 sm:px-0">
            <div className="bg-emerald-50 rounded-2xl p-4 sm:p-6 shadow-lg overflow-hidden">
              <div className="relative rounded-xl bg-white/60 border border-emerald-100 p-3 sm:p-4">
                {/* Decorative emerald smoke / blob */}
                <div
                  className="absolute -right-6 -top-4 w-40 h-40 bg-emerald-200/30 rounded-full filter blur-3xl opacity-80 pointer-events-none"
                  aria-hidden="true"
                />
