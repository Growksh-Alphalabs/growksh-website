...
export default function Community(){
  return (
    <section id="community" className="py-12 bg-rose-50">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <h3 className="text-2xl font-bold mb-3">Join The Alpha Circle — Our Learning Community</h3>
        ...
        <div className="mt-6">
          <a href="#" className="px-6 py-2 bg-yellow-400 rounded-full font-semibold">Join The Alpha Circle</a>
        </div>
      </div>
    </section>
  )
